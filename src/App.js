              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
                <div
                  ...
                  style={{
                    ...
                    borderRadius: '1rem',
                    cursor: 'pointer',
                    background: tradeType === 'pay' ? 
                      'linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%)' : 
                      'rgba(15, 23, 42, 0.8)',
                    border: tradeType === 'pay' ? 
                      '2px solid #3b82f6' : 
                      '1px solid #374151',
                    transition: 'all 0.3s ease',
                    position: 'relative',
                ...
                >
                  ...
                  <div style={{ 
                    ...
                    <div>
                      <div style={{ 
                        color: tradeType === 'pay' ? '#ffffff' : '#e2e8f0',
                        fontWeight: '700',
                        fontSize: '1.1rem',
                        marginBottom: '0.25rem'
                      }}>
                      ...
                      <div style={{ 
                        color: tradeType === 'pay' ? 'rgba(255,255,255,0.8)' : '#94a3b8',
                        fontSize: '0.875rem'
                      }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    borderRadius: '1rem',
                    cursor: 'pointer',
                    background: tradeType === 'receive' ? 
                      'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)' : 
                      'rgba(15, 23, 42, 0.8)',
                    border: tradeType === 'receive' ? 
                      '2px solid #f59e0b' : 
                      '1px solid #374151',
                    transition: 'all 0.3s ease',
                    position: 'relative',
                ...
                >
                  ...
                  <div style={{ 
                    ...
                    <div>
                      <div style={{ 
                        color: tradeType === 'receive' ? '#ffffff' : '#e2e8f0',
                        fontWeight: '700',
                        fontSize: '1.1rem',
                        marginBottom: '0.25rem'
                      }}>
                      ...
                      <div style={{ 
                        color: tradeType === 'receive' ? 'rgba(255,255,255,0.8)' : '#94a3b8',
                        fontSize: '0.875rem'
                      }}>
